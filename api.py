...
async def upload_images(
    ...
    #  force remove the case_dir if it exists
    if os.path.exists(case_dir):
        subprocess.run(["rm", "-rf", case_dir])
    ...
    for image_path in saved_file_paths:
        ...
        command = [
            ...
            "--input_yaw",  "-80", "80", "10",              # Góc quay đầu ngang 180 độ
            ...
            # "--preprocess", "crop"                   # Sử dụng ảnh đầy đủ để tạo video
        ]
